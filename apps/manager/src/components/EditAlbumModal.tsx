...
// Refonte ergonomique : en-tête et pied de page sticky,
// recherche de tags, sélection visuelle de l'ordre de tri et couverture
// ============================================================
...
const EditAlbumModal: React.FC<EditAlbumModalProps> = ({ album, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-3 sm:p-6 animate-fade-in">
      <div className="bg-gray-900 border border-white/15 rounded-3xl shadow-2xl max-w-2xl w-full flex flex-col max-h-[92vh] overflow-hidden text-white">
        ...
        <form onSubmit={handleSubmit} id="edit-album-form" className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* SECTION 2 : Type d'Album & Filtres Tags */}
          <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-4">
          ...
          <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-3">
            ...
            <p className="text-xs text-gray-400">
              Définissez comment les images seront ordonnées dans cette galerie et sur toutes les pages où elle est utilisée.
            </p>
          ...
          <div className="bg-white/5 border border-white/10 p-5 rounded-2xl space-y-4">
            ...
            {coverImage ? (
              <div className="flex items-center gap-4 p-3 bg-black/40 rounded-xl border border-white/10">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Sera affichée en vignette de la galerie sur le portfolio et dans les cartes.</p>
                </div>
              </div>
            ) : (
              <p className="text-xs text-gray-400 italic bg-black/30 p-2.5 rounded-xl border border-white/5">
                Aucune image personnalisée choisie : la première photo de la galerie sera utilisée automatiquement.
              </p>
            )}
            ...
            <div>
              ...
              {loadingPhotos ? (
                ...
                <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 max-h-44 overflow-y-auto p-2 bg-black/40 rounded-xl border border-white/10">
                  {photos.map((p: any) => {
