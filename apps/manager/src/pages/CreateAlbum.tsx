...
// À GAUCHE : Saisie (Titre, Description, Mode & Tags)
// À DROITE : Choix d'ordre de tri & validation
// ============================================================
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <label className="flex items-center gap-3 p-3.5 bg-black/30 rounded-xl border border-white/10 cursor-pointer hover:bg-black/40 transition">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Accessible sur portfolio.</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3 p-3.5 bg-black/30 rounded-xl border border-white/10 cursor-pointer hover:bg-black/40 transition">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Filtrage par tags.</p>
                    </div>
                  </label>
                </div>
            ...
            {/* COLONNE DROITE : Séquence d'ordre & Validation */}
            <div className="space-y-6">
