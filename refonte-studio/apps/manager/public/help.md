...
## 14. Architecture des domaines, Thèmes et Profil (Refonte)

LuminaView a été refondu pour offrir à chaque photographe son propre écosystème autonome de domaines web :

### Architecture de vos plateformes
Le système gère de façon transparente vos différentes applications web :
- **Portfolio Public** : Votre vitrine principale s'affiche de manière autonome à l'adresse `[votre-pseudo].helioscope.fr`.
- **Actualités (Blog)** : Votre journal public autonome à l'adresse `[votre-pseudo]-blog.helioscope.fr`.
- **Carnet de Route** : Votre espace d'exploration photographique à l'adresse `[votre-pseudo]-carnet.helioscope.fr`.
Les liens de navigation entre votre portfolio, votre blog et votre carnet se mettent à jour dynamiquement selon votre profil.

### Sélection du Thème (Portfolio)
Dans **Mon Profil**, vous pouvez toujours choisir l'apparence de votre portfolio :
...
2. **Colonne de droite (60%)** : Regroupe les formulaires de saisie de texte avec des champs très hauts facilitant l'écriture et le support Markdown (biographie, introduction, description des prestations).
